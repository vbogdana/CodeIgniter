                   ...
                   $idGroup    =$niz[$i]['IdGroup'];
                    ...
                    echo '<div class="userrow1">'. 
                           " <ul>"
                                ...
                                .'<li class="lli5">'.'<button id="mybutton" style=" background-color: transparent ; border: 0px; cursor:pointer; width:25px; height: 25px; padding: 0px; ">'.'<img  src="'. base_url()."/assets/images/png/plusbl.png".'"'. 'width="25px" height="25px">'."</button></li>
